...
#define GST_TYPE_MTKEACDEC   (gst_HALeacdec_get_type())
...
{
  GstAudioDecoder base_HALeacdec;

};

struct _GstMtkeacdecClass
{
  GstAudioDecoderClass base_HALeacdec_class;
};

GType gst_HALeacdec_get_type (void);
