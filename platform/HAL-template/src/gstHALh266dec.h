...
#define GST_TYPE_MTKH266DEC   (gst_HALh266dec_get_type())
...
{
  GstVideoDecoder base_HALh266dec;

};

struct _GstMtkh266decClass
{
  GstVideoDecoderClass base_HALh266dec_class;
};

GType gst_HALh266dec_get_type (void);
