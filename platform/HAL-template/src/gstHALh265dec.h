...
#define GST_TYPE_MTKH265DEC   (gst_HALh265dec_get_type())
...
{
  GstVideoDecoder base_HALh265dec;

};

struct _GstMtkh265decClass
{
  GstVideoDecoderClass base_HALh265dec_class;
};

GType gst_HALh265dec_get_type (void);
