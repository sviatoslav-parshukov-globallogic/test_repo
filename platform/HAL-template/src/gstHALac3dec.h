...
#define GST_TYPE_MTKAC3DEC   (gst_HALac3dec_get_type())
...
{
  GstAudioDecoder base_HALac3dec;

};

struct _GstMtkac3decClass
{
  GstAudioDecoderClass base_HALac3dec_class;
};

GType gst_HALac3dec_get_type (void);
