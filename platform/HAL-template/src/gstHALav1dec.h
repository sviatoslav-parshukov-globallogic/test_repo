...
#define GST_TYPE_MTKAV1DEC   (gst_HALav1dec_get_type())
...
{
  GstVideoDecoder base_HALav1dec;

};

struct _GstMtkav1decClass
{
  GstVideoDecoderClass base_HALav1dec_class;
};

GType gst_HALav1dec_get_type (void);
