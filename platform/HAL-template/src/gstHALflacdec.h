...
#define GST_TYPE_MTKFLACDEC   (gst_HALflacdec_get_type())
...
{
  GstAudioDecoder base_HALflacdec;

};

struct _GstMtkflacdecClass
{
  GstAudioDecoderClass base_HALflacdec_class;
};

GType gst_HALflacdec_get_type (void);
