...
#define GST_TYPE_MTKMJPEGDEC   (gst_HALmjpegdec_get_type())
...
{
  GstVideoDecoder base_HALmjpegdec;

};

struct _GstMtkmjpegdecClass
{
  GstVideoDecoderClass base_HALmjpegdec_class;
};

GType gst_HALmjpegdec_get_type (void);
