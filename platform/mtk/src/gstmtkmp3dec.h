...
#define GST_TYPE_MTKMP3DEC   (gst_mtkmp3dec_get_type())
...
{
  GstAudioDecoder base_mtkmp3dec;

};

struct _GstMtkmp3decClass
{
  GstAudioDecoderClass base_mtkmp3dec_class;
};

GType gst_mtkmp3dec_get_type (void);
