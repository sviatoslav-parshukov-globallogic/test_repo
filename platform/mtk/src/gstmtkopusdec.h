...
#define GST_TYPE_MTKOPUSDEC   (gst_mtkopusdec_get_type())
...
{
  GstAudioDecoder base_mtkopusdec;

};

struct _GstMtkopusdecClass
{
  GstAudioDecoderClass base_mtkopusdec_class;
};

GType gst_mtkopusdec_get_type (void);
