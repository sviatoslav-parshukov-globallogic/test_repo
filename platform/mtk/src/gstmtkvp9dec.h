...
#define GST_TYPE_MTKVP9DEC   (gst_mtkvp9dec_get_type())
...
{
  GstVideoDecoder base_mtkvp9dec;

};

struct _GstMtkvp9decClass
{
  GstVideoDecoderClass base_mtkvp9dec_class;
};

GType gst_mtkvp9dec_get_type (void);
