...
#define GST_TYPE_MTKAACDEC   (gst_mtkaacdec_get_type())
...
{
  GstAudioDecoder base_mtkaacdec;

};

struct _GstMtkaacdecClass
{
  GstAudioDecoderClass base_mtkaacdec_class;
};

GType gst_mtkaacdec_get_type (void);
