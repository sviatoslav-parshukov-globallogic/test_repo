...
#define GST_TYPE_MTKDTSXP2DEC   (gst_mtkdtsxp2dec_get_type())
...
{
  GstAudioDecoder base_mtkdtsxp2dec;

};

struct _GstMtkdtsxp2decClass
{
  GstAudioDecoderClass base_mtkdtsxp2dec_class;
};

GType gst_mtkdtsxp2dec_get_type (void);
