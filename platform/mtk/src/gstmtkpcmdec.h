...
#define GST_TYPE_MTKPCMDEC   (gst_mtkpcmdec_get_type())
...
{
  GstAudioDecoder base_mtkpcmdec;

};

struct _GstMtkpcmdecClass
{
  GstAudioDecoderClass base_mtkpcmdec_class;
};

GType gst_mtkpcmdec_get_type (void);
