...
#define GST_TYPE_MTKH264DEC   (gst_mtkh264dec_get_type())
...
{
  GstVideoDecoder base_mtkh264dec;

};

struct _GstMtkh264decClass
{
  GstVideoDecoderClass base_mtkh264dec_class;
};

GType gst_mtkh264dec_get_type (void);
