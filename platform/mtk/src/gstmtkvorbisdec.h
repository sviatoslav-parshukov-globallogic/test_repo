...
#define GST_TYPE_MTKVORBISDEC   (gst_mtkvorbisdec_get_type())
...
{
  GstAudioDecoder base_mtkvorbisdec;

};

struct _GstMtkvorbisdecClass
{
  GstAudioDecoderClass base_mtkvorbisdec_class;
};

GType gst_mtkvorbisdec_get_type (void);
