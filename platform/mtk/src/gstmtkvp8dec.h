...
#define GST_TYPE_MTKVP8DEC   (gst_mtkvp8dec_get_type())
...
{
  GstVideoDecoder base_mtkvp8dec;

};

struct _GstMtkvp8decClass
{
  GstVideoDecoderClass base_mtkvp8dec_class;
};

GType gst_mtkvp8dec_get_type (void);
